...
def ShowTeam(request):
    return render(request,'MoviePost/Team.html',{"key":"Data from Database"})

def Director(request):
    return render(request,'MoviePost/Director.html',{"key":"Data from Database"})

def Mo(request):
    return render(request,'MoviePost/Mo.html',{"key":"Data from Database"})

def Latest(request):
    return render(request,'MoviePost/Latest.html',{"key":"Data from Database"})

def Movie(request):
    return render(request,'MoviePost/Movie Streaming.html',{"key":"Data from Database"})

def Popular(request):
    return render(request,'MoviePost/Popular.html',{"key":"Data from Database"})

def Up(request):
    return render(request,'MoviePost/Up.html',{"key":"Data from Database"})
...
def theark(request):
    return render(request,'MoviePost/yes/the ark.html',{"key":"Data from Database"})

def theblacklist(request):
    return render(request,'MoviePost/yes/the blacklist.html',{"key":"Data from Database"})

def theman(request):
    return render(request,'MoviePost/yes/the man.html',{"key":"Data from Database"})

def the(request):
    return render(request,'MoviePost/yes/the.html',{"key":"Data from Database"})

def they(request):
    return render(request,'MoviePost/yes/they.html',{"key":"Data from Database"})

def todos(request):
    return render(request,'MoviePost/yes/todos.html',{"key":"Data from Database"})

def vikings(request):
    return render(request,'MoviePost/yes/vikings.html',{"key":"Data from Database"})

def warchief(request):
    return render(request,'MoviePost/yes/warchief.html',{"key":"Data from Database"})
